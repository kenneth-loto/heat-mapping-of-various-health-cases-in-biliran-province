...
<body>
          ...
          <div class="col-md-8 col-lg-6 col-xxl-5">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <h4 class="text-center mb-4 mt-2"><strong>Heat Mapping of Various Health Cases<br>(HMVHC)</strong></h4>
                <?php
                  $msg = Session::get("msg");
                  if (isset($msg)) {
                      echo $msg;
                ...
                ?>
                <form method="post" action="../navigate.php" class="mt-5" enctype="multipart/form-data">

                <h6 class="fw-bold mb-4">NAME OF DECLARANT</h6>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        value="<?php echo isset($_SESSION['form_data']['contact_number']) ? htmlspecialchars($_SESSION['form_data']['contact_number']) : ''; ?>"
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="municipality" name="municipality" required>
                            ...
                            foreach ($municipalities as $municipality) {
                                echo '<option value="' . htmlspecialchars($municipality->municipality_name) . '">' . htmlspecialchars($municipality->municipality_name) . '</option>';
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="street" value="<?php echo isset($_SESSION['form_data']['street']) ? htmlspecialchars($_SESSION['form_data']['street']) : ''; ?>" placeholder="e.g. Garcia">
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="row">
                    <div class="col-md-12 mb-4">
                        <label for="valid_id_path">Valid ID <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" id="valid_id_path" name="valid_id_path" accept="image/*" required>
                  ...
                  <div class="d-flex justify-content-center">
                    <button name="btn-create-municipality-user" type="submit" class="btn w-50 py-2 fs-4 mb-4 rounded-2 text-light" style="background-color: #006666" 
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a class="fw-bold ms-2" href="municipality_user_login.php" style="color: #006666">Sign In</a>
                  </div>
                </form>
              </div>
            </div>
  ...
  <script>
    document.getElementById('valid_id_path').addEventListener('change', function(event) {
