...
// Fetch the municipality using the new function
$municipality = $function->getMunicipalityByEmail($email);
    ...
    <aside class="left-sidebar">
      ...
      <div>
        ...
        <div class="text-center mt-3"> <!-- Centering div -->
          <h3 class="fw-semibold">Municipality of <?php echo htmlspecialchars($municipality); ?></h3>
        </div>
        <div>
