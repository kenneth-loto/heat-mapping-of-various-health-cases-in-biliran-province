...
$diseases = $function->getDistinctDiseases();  // Call method
?>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-auto">
                        ...
                        <div class="form-group text-dark mb-3">
                            ...
                            <select name="municipality" id="municipality" onchange="this.form.submit()" class="form-control w-auto">
                                <option value="">All</option>
                                <?php foreach ($municipalities as $municipalityOption): ?>
                                    <option value="<?php echo $municipalityOption['municipality_name']; ?>" <?php echo $municipality == $municipalityOption['municipality_name'] ? 'selected' : ''; ?>>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="table">
                            ...
                            <tbody class="text-dark">
                                ...
                                $patients = $function->getFilteredPatients($disease, $municipality); // Fetch filtered disease data
