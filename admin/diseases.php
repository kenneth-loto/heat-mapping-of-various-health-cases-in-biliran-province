...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn fw-bold mb-3 text-light" role="button" href="add_disease.php" style="background-color: #006666">Add Disease</a>
                            ...
                            <tbody class="text-dark">
                                ...
                                ?>
                                        <tr class="text-align-left">
                                            ...
                                            <td><?= $disease->name_of_disease; ?></td>
                                            <td><?= $disease->short_description; ?></td>
                                            <td><?= $disease->disease_category; ?></td>
                                            <td>
                                                <div  class="d-flex">
                                                    <a class="btn me-2 text-light" style="background-color: #006666" href="update_disease.php?id=<?= $id; ?>" title="Edit Disease">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action='../navigate.php' method='post' style='display: inline;'>
                                                        <input type='hidden' name='id' value='<?= $id; ?>'>
                                                        <button class='btn text-light' style="background-color: #006666" name='btn-delete-disease' type='submit' onclick="return confirm('Are you sure you want to delete this disease?');" title='Delete Disease'>
