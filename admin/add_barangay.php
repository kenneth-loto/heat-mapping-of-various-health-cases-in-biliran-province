        ...
        <div class="card-body">
            ...
            <form method="post" action="../navigate.php" enctype="multipart/form-data">
                ...
                <div class="row text-dark">
                    <div class="col-md-12 mb-4">
                        ...
                        <select class="form-select" id="municipality_name" name="municipality_name" required>
                            ...
                            <?php
                            // Loop through the municipalities array to create options with the municipality_id as value
                            foreach ($municipalities as $municipality) {
                                echo '<option value="' . htmlspecialchars($municipality['municipality_name']) . '" data-geometry=\'' . json_encode($municipality['geom']) . '\'>' . htmlspecialchars($municipality['municipality_name']) . '</option>';
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="d-flex justify-content-center mt-4">
                    <button type="submit" class="btn btn-primary me-3 w-25 py-2 fs-4 mb-4 rounded-2" name="btn-add-barangay" onclick="return confirm('Are you sure you want to submit? Please review the details before proceeding.');" style="justify-content: center !important;" title="Submit">Submit</button>
