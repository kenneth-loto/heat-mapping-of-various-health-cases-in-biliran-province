            ...
            <form method="post" action="../navigate.php" enctype="multipart/form-data">
                <div class="row text-dark">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" class="form-control" name="patients_id" value="<?php echo isset($_SESSION['form_data']['patients_id']) ? htmlspecialchars($_SESSION['form_data']['patients_id']) : ''; ?>" placeholder="e.g. Juan Dela Cruz" required>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center mt-4">
                    <button type="submit" class="btn btn-primary me-3 w-25 py-2 fs-4 mb-4 rounded-2" name="btn-add-cases" onclick="return confirm('Are you sure you want to submit? Please review the details before proceeding.');" style="justify-content: center !important;" title="Submit">Submit</button>
