                ...
                <div class="col-auto">
                    ...
                    <form method="GET" action="">
                        <div class="form-group text-dark mb-3">
                            ...
                            <select name="municipality_name" id="municipality_name" onchange="this.form.submit()" class="form-control w-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="table">
                            ...
                            <tbody class="text-dark">
                                ...
                                $barangays = $function->getFilteredBarangays($municipality); // Pass selected municipality
